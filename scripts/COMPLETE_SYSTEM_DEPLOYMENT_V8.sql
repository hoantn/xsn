-- =====================================================
-- SCRIPT TRIỂN KHAI HỆ THỐNG HOÀN CHỈNH (PHIÊN BẢN V8)
-- Khắc phục lỗi: Thêm 'proxy_purchase' và 'refund' vào CHECK constraint của transactions.type (cập nhật lại).
-- Đảm bảo các ràng buộc UNIQUE và cột 'secret' vẫn đúng.
