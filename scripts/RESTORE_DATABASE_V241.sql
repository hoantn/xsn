-- =====================================================
-- KHÔI PHỤC DATABASE CHO PHIÊN BẢN V241
-- Script này sẽ tái tạo lại database theo đúng cấu trúc
-- mà code v241 đang sử dụng
-- =====================================================
...
-- 2. Tạo bảng proxies (đã có sẵn, chỉ cần đảm bảo cấu trúc)
-- Giả sử bảng proxies đã tồn tại, chỉ thêm các cột cần thiết
...
-- 9. Tạo function update_updated_at_column
...
-- 11. Thêm admin accounts mặc định
...
-- 12. Thêm dữ liệu mẫu cho proxy_plans
...
-- 13. Tạo function purchase_proxy_plan (sử dụng bảng users)
