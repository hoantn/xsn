-- =====================================================
-- SCRIPT TRIỂN KHAI HỆ THỐNG HOÀN CHỈNH (PHIÊN BẢN V2)
...
CREATE TABLE IF NOT EXISTS bank_accounts (
  ...
  account_holder_name TEXT NOT NULL, -- Đã sửa tên cột
...
-- 9. Đảm bảo cột account_holder_name tồn tại trong bank_accounts
DO $$
BEGIN
    IF EXISTS (
